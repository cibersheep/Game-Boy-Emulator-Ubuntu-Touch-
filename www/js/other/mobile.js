...
function loadViaXHR () {
  ...
  xhr.open("GET", "roms/espionage.gb");
...
var gameBoyColors = ["#fc4949", "#762572", "#3fb24f", "#f5f5f5"];
...
function windowingInitialize() {
  ...
  //ctx.fillText("Tap to load ROM", 60, 70);
  var imageObj = new Image();

      imageObj.onload = function() {
        ctx.drawImage(imageObj, 80, 20);
      };
      imageObj.src ="images/cart.png";

  //load rom gui
  var cart = document.getElementById ('canvas_container');
